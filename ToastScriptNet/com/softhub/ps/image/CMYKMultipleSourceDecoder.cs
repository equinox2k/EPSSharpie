namespace com.softhub.ps.image
{
	...
	internal class CMYKMultipleSourceDecoder : CMYKPixelSource
	{
		...
		internal CMYKMultipleSourceDecoder(ImageDataProducer producer, object[] procs, int bits)
		{
		...
		internal CMYKMultipleSourceDecoder(CharStream[] data, int bits)
		{
