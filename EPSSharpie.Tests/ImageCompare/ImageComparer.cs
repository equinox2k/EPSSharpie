...
using System.Linq;
using EPSSharpie.Tests.ImageCompare.Exceptions;
...
namespace EPSSharpie.Tests.ImageCompare
{
    public abstract class ImageComparer
    {
        ...
        public abstract ImageSimilarityReport<TPixelA, TPixelB> CompareImagesOrFrames<TPixelA, TPixelB>(ImageFrame<TPixelA> expected, ImageFrame<TPixelB> actual)
